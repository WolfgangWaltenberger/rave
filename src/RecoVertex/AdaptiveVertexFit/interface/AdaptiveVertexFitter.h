...
public:
  ...
  */
  ...
  /**
   *  Weight==0. confuses the Kalman filter.
   *  So we just set weight to 1e-20 or something, in this case.
   */
  ...
  void setParameters( double maxshift=0.0001, double maxlpshift=0.1, 
                      unsigned maxstep=30, double weightthreshold=.001, double minWeight=1e-20 );
