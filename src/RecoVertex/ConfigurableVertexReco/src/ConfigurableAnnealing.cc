  ...
  theImpl( 0 )
{
  ...
  // edm::LogWarning("ConfigurableAnnealing") << "below one code is still here.";
  if ( type == "below" )
  {
...
void ConfigurableAnnealing::warmUp()
{
  theImpl->warmUp();
}
...
/*
void ConfigurableAnnealing::setTemperature ( float T )
{
  theImpl->setTemperature ( T );
}
*/
...
/*
inline double ConfigurableAnnealing::phi( double chi2, float T ) const
{
  return theImpl->phi ( chi2, T );
}
*/
