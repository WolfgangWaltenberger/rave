...
{
  cout << "[ConfigurableVertexReconstructor] FIXME use ghost track!!" << endl;
  return theRector->vertices ( prims, secs, s );
  // return theRector->vertices ( prims, secs, s, g );
}
...
{
  cout << "[ConfigurableVertexReconstructor] FIXME use ghost track!!" << endl;
  // cout << "ConfigurableVertexReconstructor: method vertices( t, s, g) is called" << endl;
  return theRector->vertices ( t, s );
