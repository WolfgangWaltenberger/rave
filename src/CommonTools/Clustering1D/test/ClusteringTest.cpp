...
namespace
{
  ...
  void run ( const vector < Cluster1D<string> > & input )
  {
    ...
    #ifdef HaveMulti
    FsmwClusterizer1D<string> sub;
    MultiClusterizer1D<string> multi ( sub );
    ret= multi( input );
    cout << endl << "Multi finds: " << endl;
    print ( ret );
    #endif

    #ifdef HaveOutermost
    OutermostClusterizer1D<string> outermost;
    ret= outermost( input );
    cout << endl << "Outermost finds: " << endl;
    print ( ret );
    #endif
...
int main( int argc, char ** argv )
{
  ...
  if (false)
  {
    cout << endl
              << "Four Items:" << endl
              << "============" << endl;
    vector < Cluster1D<string> > input = fourItems();
    run ( input );
  }
  ...
  if (false)
  {
    cout << endl
              << "Seven:" << endl
              << "============" << endl;
    vector < Cluster1D<string> > input = createInput( 7 );
    run ( input );
  }
  if (true)
  {
    cout << endl
              << "Twelve:" << endl
              << "============" << endl;
    vector < Cluster1D<string> > input = createInput( 12 );
    run ( input );
  }
}
