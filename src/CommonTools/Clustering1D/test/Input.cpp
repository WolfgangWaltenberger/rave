#ifndef Clusterizer1DInput
#define Clusterizer1DInput
...
namespace
{
  ...
  {
      vector < Cluster1D<string> > ret;
      ret.push_back ( createCluster ( 0.1, 0.10, 1. ) );
      ret.push_back ( createCluster ( 0.3, 0.05, 1. ) );
      ret.push_back ( createCluster ( 1.0, 0.05, 1. ) );
      return ret;
  }
